...
#* Team Id : SR#7147
#* Author List : eYantra
#* Filename: capture_cell_coordinates.py
#* Theme: Survay And Rescue
#* Functioning : This script helped us to record the cell coordinates in 2D and store them in .json format as per the cell/block named as "cell_coords.json". 
#				 It subscribe to whycon/poses (which is camera output with whycon coordinates).
